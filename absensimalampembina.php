<?php
  ...
  mahasiswa.nim, mahasiswa.nama FROM absensimalam, mahasiswa WHERE absensimalam.nim=mahasiswa.nim ORDER BY tanggal, waktu');
  ...
  <section id="services2">
    ...
    <div class="container px-3 px-lg-5">
      ...
      <tr>
        ...
        <td><a href="cetakabsensimalam.php?tanggalcetak=<?php echo $tanggalcetak ?>" class='btn btn-xs btn-success noPrint'>Cetak Tanggal</a></td>
