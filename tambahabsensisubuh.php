<?php
  ...
  if(isset($_POST['submit'])){
    ...
    $result = mysqli_query($mysqli, "INSERT INTO absensisubuh(tanggal, waktu, nim, statuskehadiran) 
    VALUES ('$tanggal','$waktu','$nim','$statuskehadiran')");
    
    if($result){
      echo "<script>
              var info = 'Absensi Subuh Berhasil Ditambahkan!';  
              window.alert(info);
              document.location='absensisubuh.php'; 
            </script>";
    }
    else{
      echo "<script> 
              var info = 'Absensi Subuh Gagal Ditambahkan!'; 
              window.alert(info);
              document.location='tambahabsensisubuh.php'; 
            </script>";
    }
  }
...
<head>
  ...
  <title>Form Absensi Subuh</title>
...
<body>
  ...
  <section id="services3">
    ...
    <div class="container px-3 px-lg-4">
      ...
      <div class="card-body">    
      <form method="post" action="tambahabsensisubuh.php">    
