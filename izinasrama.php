<?php
  ...
  $nim = $_SESSION['nim'];
  $result = mysqli_query($mysqli, 'SELECT * FROM izinasrama WHERE nim="'.$nim.'"');
...
<body>
  ...
  <section id="services2">
    ...
    <div class="container px-3 px-lg-5">
      <a href="tambahizinasrama.php" class='btn btn-xs btn-primary'>Tambah Perizinan</a><br><br>
      <div class="card mt-0">
