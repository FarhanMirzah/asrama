    ...
    <div class="container" data-aos="fade-up">
      ...
      <div class="row">
        <div class="col-lg-4 col-md-6" data-aos="zoom-in">
          <div class="box">
            <div class="icon"><a href="absensisubuhpembina.php"><i class="bi bi-card-checklist"></i></a></div>
            <h4 class="title"><a href="absensisubuhpembina.php">Absensi Subuh</a></h4>
            <p class="description">Absensi subuh dilakukan ketika selesai shalat subuh berjamaah dengan melengkapi form</p>
          </div>
        </div>
        <div class="col-lg-4 col-md-6" data-aos="zoom-in">
          <div class="box">
            <div class="icon"><a href="absensimalampembina.php"><i class="bi bi-card-checklist"></i></a></div>
            <h4 class="title"><a href="absensimalampembina.php">Absensi Malam</a></h4>
            <p class="description">Absensi malam dilakukan ketika selesai shalat isya berjamaah dengan melengkapi form</p>
          </div>
        </div>
        <div class="col-lg-4 col-md-6" data-aos="zoom-in">
          <div class="box">
            <div class="icon"><a href="izinasramapembina.php"><i class="bi bi-card-checklist"></i></a></div>
            <h4 class="title"><a href="izinasramapembina.php">Izin Asrama</a></h4>
